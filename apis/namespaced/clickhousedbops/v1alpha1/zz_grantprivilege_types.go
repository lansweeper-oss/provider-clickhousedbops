...
type GrantPrivilegeInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	GranteeRoleNameRef *v2.NamespacedReference `json:"granteeRoleNameRef,omitempty" tf:"-"`

	// Selector for a Role in clickhousedbops to populate granteeRoleName.
	// +kubebuilder:validation:Optional
	GranteeRoleNameSelector *v2.NamespacedSelector `json:"granteeRoleNameSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	GranteeUserNameRef *v2.NamespacedReference `json:"granteeUserNameRef,omitempty" tf:"-"`

	// Selector for a User in clickhousedbops to populate granteeUserName.
	// +kubebuilder:validation:Optional
	GranteeUserNameSelector *v2.NamespacedSelector `json:"granteeUserNameSelector,omitempty" tf:"-"`
