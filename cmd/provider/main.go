...
import (
	...
	apisCluster "github.com/lansweeper-oss/provider-clickhousedbops/apis/cluster"
	apisNamespaced "github.com/lansweeper-oss/provider-clickhousedbops/apis/namespaced"
	...
	controllerCluster "github.com/lansweeper-oss/provider-clickhousedbops/internal/controller/cluster"
	controllerNamespaced "github.com/lansweeper-oss/provider-clickhousedbops/internal/controller/namespaced"
	"github.com/lansweeper-oss/provider-clickhousedbops/internal/features"
	"github.com/lansweeper-oss/provider-clickhousedbops/internal/version"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-clickhousedbops"))
	if cli.Debug {
	...
	// So resources that already exist (e.g. after a restore, or an import by name) are
	...
	if cli.EnableChangeLogs {
		...
		clo := xpcontroller.ChangeLogOptions{
			ChangeLogger: managed.NewGRPCChangeLogger(
				...
				managed.WithProviderVersion(fmt.Sprintf("provider-clickhousedbops:%s", version.Version))),
		}
